...
RootAsRole reaches a major stabilization milestone with the modernized execution stack and crate split (`rar-common`, `rar-exec`). Documentation is refocused on operational usage, policy clarity, and contributor architecture. A comprehensive PhD thesis @@billo2025 consolidates the research foundation and design rationale for the project.